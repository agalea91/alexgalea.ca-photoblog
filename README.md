...
The docker version is a WIP.

For now, get it up and running by following the instructions in the Dockerfiles. You need to start the Flask server and the Vue app using yarn.
